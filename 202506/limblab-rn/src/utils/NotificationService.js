...
export default class NotificationService {
    ...
    PushNotification.createChannel(
      {
        ...
        channelName: `Badge only notifications 2`,
        channelDescription: "No sound no notification invisible just badge update",
        playSound: false,
        soundName: "default",
        importance: Importance.LOW,
        vibrate: false
      },
      created => console.log(`createChannel 'badge-only-channel2' returned '${created}'`) // (optional) callback returns whether the channel was created, false means it already existed.
    );
  }
  ...
  localNotif(notificationMessage, soundName) {
    this.lastId++;
    PushNotification.localNotification({
